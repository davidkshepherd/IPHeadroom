...
print("=" *2)
percent50 = input("== Report ONLY used IPs above 50%?  Y/n: ")
print("=" *2)
showbar = input("== Do you want to see a Bar Chart?  n/Y: ")
print("=" *2)
showscatter = input("== Do you want to see a Scatter Plot?  n/Y: ")
print("=" * 41, " IP Headroom Tool ", "=" * 41)
print("")
print("=" * 46, " Results ", "=" * 46)
